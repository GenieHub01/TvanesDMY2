            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="down-menu">
                            <p class="eac-item"><a href="<?= \yii\helpers\Url::to('turbo-actuator') ?>">TURBO ACTUATOR</a></p>
                            <p class="eac-item"><a href="<?= \yii\helpers\Url::to('turbo-actuator-position-sensor') ?>">TURBO ACTUATOR POSITION SENSOR
                                </a></p>
                            <p class="eac-item"><a href="<?= \yii\helpers\Url::to('turbo-charger') ?>">TURBO CHARGER</a></p>
                            <p class="eac-item"><a href="<?= \yii\helpers\Url::to('turbo-cleaner') ?>">TURBO CLEANER</a></p>
                        </div>
